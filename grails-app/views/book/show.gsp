	...
	<body>
		...
		<div id="show-book" class="content scaffold-show" role="main">
			...
			<ol class="property-list book">
				...
				<g:if test="${bookInstance?.bookId}">
				<li class="fieldcontain">
					<span id="bookId-label" class="property-label"><g:message code="book.bookId.label" default="Book Id" /></span>
					
						<span class="property-value" aria-labelledby="bookId-label"><g:fieldValue bean="${bookInstance}" field="bookId"/></span>
