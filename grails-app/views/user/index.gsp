			...
			<thead>
				...
				<g:each in="${userInstanceList}" status="i" var="userInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                        ...
                        <td>
                            <fieldset class="form">
                                <g:form controller="user" action="wishList" method="POST" params="${[userId:userInstance.id]}">
                                    <div class="fieldcontain">
                                        <button id="addButton" type="submit">Wish List</button>
                                    </div>
                                </g:form>
                            </fieldset>
                        </td>
